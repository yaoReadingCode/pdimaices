...
public class SepararObjetosViejo extends AbstractImageCommand {
	...
	DetectarContornoViejo detectarContorno = null;
	
	public SepararObjetosViejo(PlanarImage image, List<Objeto> objetos, DetectarContornoViejo detectarContornoViejo) {
		super(image);
		this.objetos = objetos;
		this.detectarContorno = detectarContornoViejo;
	}


	public SepararObjetosViejo(PlanarImage image, List<Objeto> objetos, int ventanaPixeles) {
		super(image);
		this.objetos = objetos;
