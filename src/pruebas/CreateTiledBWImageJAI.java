...
/*
   ...
   public class CreateTiledBWImageJAI
     ...
     public static void main(String[] args)
       ...
       int width = 10240; int height = 10240;
       // The tile dimensions.
       int tWidth = 256; int tHeight = 256;
       // We need a sample model where the pixels are packed into one data type.
       MultiPixelPackedSampleModel sampleModel = new MultiPixelPackedSampleModel(DataBuffer.TYPE_BYTE,tWidth,tHeight,1); // one bit per pixel
