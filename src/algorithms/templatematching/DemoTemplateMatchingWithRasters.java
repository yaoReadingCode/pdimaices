...
/**
 * This class demonstrates the usage of the TemplateMatchingWithRasters
 * but without running it as a separate thread.
 */
public class DemoTemplateMatchingWithRasters
  {
  /**
  ...
  public static void main(String[] args)
    ...
    if (args.length != 2)
      {
      System.err.println("Usage: java algorithms.common.templatematching.DemoTemplateMatchingWithRasters "+
                         "image template");
      System.exit(0);
      }
    ...
    // Create the TemplateMatchingWithRasters instance and run it (threadless)
    TemplateMatchingWithRasters tm = new TemplateMatchingWithRasters(image,template);
    ...
    frame.getContentPane().add(new DisplayTwoSynchronizedImages(image,output));
