 ...
 * user to choose parameters and number of colors and to see the results side by
...
public class ColorQuantizer extends JFrame implements ActionListener {
	...
	public ColorQuantizer(String filename, PlanarImage image) {
		...
		method = new JComboBox(new String[] { "Median-Cut", "NeuQuant",
				"Oct-Tree" });
		...
		colors = new JComboBox(new String[] { "2", "4", "8", "16", "32", "64",
				"128" });
	...
	public void actionPerformed(ActionEvent e) {
		// We get the threshold using histograms and the minimum fuzziness
		// method.
	...
	public static void main(String[] args) {
		...
		if (args.length != 1) {
			System.err
					.println("Usage: java jai.operators.point.ColorQuantizer image");
			System.exit(0);
		}
		// Read the image.
