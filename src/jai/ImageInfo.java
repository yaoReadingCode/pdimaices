...
public class ImageInfo {
	public static void main(String[] args) {
		...
		if ((pi.getNumXTiles() != 1) || (pi.getNumYTiles() != 1)) // Is it
																	// tiled?
		{
			// Tiles number, dimensions and coordinates.
			System.out.print("Tiles: ");
			System.out.print(pi.getTileWidth() + "x" + pi.getTileHeight()
					+ " pixels" + " (" + pi.getNumXTiles() + "x"
					+ pi.getNumYTiles() + " tiles)");
			System.out.print(" (from " + pi.getMinTileX() + ","
					+ pi.getMinTileY() + " to " + pi.getMaxTileX() + ","
					+ pi.getMaxTileY() + ")");
